...
const MintPage: NextPage = () => {
  ...
  const [contract, setContract] = React.useState(
    new Contract(CA, BrandCentralAuctionInterface)
  )
  ...
  React.useEffect(() => {
    if (account && library) {
      setContract(new Contract(CA, BrandCentralAuctionInterface, library.getSigner(account)))
    }
  }, [account, library])
  ...
  return (
    <div className="block">
      <Head>
        <title>Mint - BrandCentralAuction</title>
        <meta
          name="description"
          content="This is the page for minting BrandCentralAuction"
        />
      </Head>
